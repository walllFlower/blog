...
4. 学习ant design相关组件，虽然没有涉及业务，但是功能相对完善，包括多种行业案例等-宋
5. 这周感觉压力很大、任务重，既要完成开发任务、也要完成培训、还需要解决代码生成器相关bug、还需要编写代码规范、修改封装基础组件。一个字总结本周感觉-累 -刘志鹏
...
5. 本周末完成编写完成代码规范,修改树表案例的bug、同时要优化树性能、封装基础组件 -刘志鹏
